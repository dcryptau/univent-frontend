...
// console.log(data)
  ...
  const handleRegistration = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/events/${eventId}/register`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
        }
  ...
  const handleUnregister = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/events/${eventId}/unregister`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
        }
  ...
  const fetchAttendanceData = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/events/${eventId}/attendance`, {
        headers: {
          'Authorization': `Bearer ${token}`,
        }
      });
