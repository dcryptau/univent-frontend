  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch user details
        const userResponse = await fetch(`${import.meta.env.VITE_APP_API_URL}/user/${id}`, {
          headers: {
        ...
        const eventsResponse = await fetch(`${import.meta.env.VITE_APP_API_URL}/events/registered`, {
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`,
          },
