    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-white px-4">
        <div className="absolute top-4 left-4">
            <img src="/logo.jpg" alt="Univent Logo" className="w-20 h-20 rounded-full" />
        </div>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto text-center">
          {[
            { title: "Discover Events", desc: "Find exciting events happening around your campus" },
            { title: "Connect with Peers", desc: "Meet like-minded students and build connections" },
            { title: "Stay Updated", desc: "Never miss important campus activities and events" }
          ].map((feature, index) => (
